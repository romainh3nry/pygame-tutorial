...
class SERPENT(pygame.sprite.Sprite):
  def __init__(self):
    ...
    self.SON_NOURRITURE = pygame.mixer.Sound('../sound/NOURRITURE.wav')
    self.SON_NOURRITURE.set_volume(1.0)

    self.TETE = pygame.image.load("../img/TETE.png").convert_alpha()
...
class CORPS(pygame.sprite.Sprite):
  def __init__(self, x, y):
    ...
    self.image = pygame.image.load("../img/CORPS.png").convert_alpha()
...
class NOURRITURE(pygame.sprite.Sprite):
  def __init__(self):
    ...
    self.image = pygame.image.load("../img/NOURRITURE.png").convert_alpha()
...
SON_NOURRITURE = pygame.mixer.Sound('../sound/NOURRITURE.wav')
